      ...
      {waypoints.map((waypoint, index) => {
        ...
        return (
          <li key={waypoint.id} className="waypoint-list__item">
            ...
            {leg && (
              <div className="waypoint-list__leg-compact">
                {leg.distance !== null ? (
                  <>
                    <span className="waypoint-list__leg-value">{leg.distance} LY</span>
                    {leg.jumps !== null && (
                      <span className="waypoint-list__leg-jumps">~{leg.jumps}j</span>
                    )}
                  </>
                ) : (
                  <span className="waypoint-list__leg-unknown">?</span>
                )}
              </div>
            )}
            ...
            {/* Detalhe visível ao hover */}
            <div className="waypoint-list__item-detail" aria-hidden="true">
              ...
              {leg?.distance !== null && leg && (
                <span>FROM PREV: {leg.distance} LY</span>
              )}
            </div>
