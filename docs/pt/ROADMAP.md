...
| 🚧 WIP     | 🟠         | Botao Adicionar sistema atual como waypoint    | 1 clique no StatusBar        |
| 🚧 WIP     | 🟠         | Marcar waypoint como visitado ao fazer FSDJump | Via JournalWatcher           |
| 🚧 WIP     | 🟠         | StatusBar atualiza em tempo real ao fazer jump | Ja parcialmente implementado |
