...
|--------|----------|---------|-------|
| ✅ Done | 🔴 | Save and load routes | electron-store v8 |
| ✅ Done | 🔴 | Elite Dangerous running detection | Check active process |
| ⏳ Pending | 🟠 | Add current system as waypoint | 1-click from StatusBar |
...
| ⏳ Pending | 🟡 | Ship selector with automatic jump range | Inara data |
